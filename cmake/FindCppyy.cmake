...
find_library(LibCling_LIBRARY Cling PATHS ${Cppyy_DIR}/lib)
...
function(cppyy_add_bindings pkg pkg_version author author_email)
  ...
  if ("${ARG_README_FILE}" STREQUAL "")
    set(ARG_README_FILE ${CMAKE_SOURCE_DIR}/README.md)
  endif ()
...
#  message(FATAL_ERROR "${ARG_HEADERS}")
  ...
  if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    target_link_options(${lib_name} PUBLIC -undefined dynamic_lookup)
  else()
