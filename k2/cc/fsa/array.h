...
#ifndef K2_CC_FSA_ARRAY_H_
#define K2_CC_FSA_ARRAY_H_
...
struct iterator_traits<kk::StridedPtr<T, I>> {
  typedef T value_type;
};

template <typename T, typename I>
void swap(kk::StridedPtr<T, I> &lhs, kk::StridedPtr<T, I> &rhs) {
  lhs.Swap(rhs);
}

template <typename Ptr, typename I>
void swap(kk::Array2<Ptr, I> &lhs, kk::Array2<Ptr, I> &rhs) {
  lhs.Swap(rhs);
}

}  // namespace std

#endif  // K2_CC_FSA_ARRAY_H_
