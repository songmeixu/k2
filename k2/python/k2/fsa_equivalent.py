...
from k2._k2 import _RandPath
from k2._k2 import _is_rand_equivalent
from k2._k2 import _is_rand_equivalent_max_weight
from k2._k2 import _is_rand_equivalent_logsum_weight
from k2._k2 import _is_rand_equivalent_after_rmeps_pruned_logsum
...
def is_rand_equivalent_max_weight(
    fsa_a: Fsa,
    ...
    return _is_rand_equivalent_max_weight(
        fsa_a.get_base(),
        a_weights.get_base(),
        fsa_b.get_base(),
        b_weights.get_base(),
...
def is_rand_equivalent_logsum_weight(
    fsa_a: Fsa,
    a_weights: FloatArray1,
    fsa_b: Fsa,
    b_weights: FloatArray1,
    ...
    return _is_rand_equivalent_logsum_weight(
        fsa_a.get_base(),
        a_weights.get_base(),
        fsa_b.get_base(),
        b_weights.get_base(),
...
def is_rand_equivalent_after_rmeps_pruned_logsum(
    fsa_a: Fsa,
    a_weights: FloatArray1,
    fsa_b: Fsa,
    b_weights: FloatArray1,
