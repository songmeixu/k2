...
public:
    ...
    inline bool NumAxes() const {
        return impl_->shape.NumAxes();
    }

    inline int32_t Dim(int32_t i) {
        return impl_->shape.Dim(i);
    }
    inline std::vector<int32_t> Dims() {
        return impl_->shape.Dims();
    }
    inline int32_t Stride(int32_t i) {
        return impl_->shape.Stride(i);
    }
    inline std::vector<int32_t> Strides() {
        return impl_->shape.Strides();
    }
    inline int32_t Nelement(int32_t i) {
        return impl_->shape.Nelement();
    }
    inline bool IsContiguous() {
        return impl_->shape.IsContiguous();
    }
